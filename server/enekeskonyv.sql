...
INSERT INTO `song` (`id`, `version`, `title`, `song`, `sheet_music`, `language`, `other_languages`, `labels`, `comment`) VALUES
(1, 1, 'ez egy cím', 'ez meg egy leíró', 'na ez meg egy kotta', 1, '0', '', ''),
(2, 1, 'ez egy keres', 'ez meg egy leíró', 'na ez meg egy kotta', 1, '0', '', ''),
(3, 1, 'ez egy másik', 'ez meg egy leíró', 'na ez meg egy kotta', 1, '0', '', ''),
(4, 1, 'ebben is benne van, hogy cím', 'ez meg egy leíró', 'na ez meg egy kotta', 1, '0', '', ''),
(5, 1, 'ez egy cím', 'üöplokjhgf', '', 2, '0', '', ''),
(6, 1, 'ez egy cím', 'üöplokjhgfÖÜÓŐÚÉÁŰÍ öüóőúéáűí ez most egy kicsit hosszabb lesz, remélem már kifolyik az ötven karakterből', '', 1, '0', '', ''),
(7, 1, 'Példaének', 'Atyám két kezedben, te vagy a lakhatom...[a][v][r][b][/b][/r][/v][/a]', 'options stave-distance=30 space=10\ntabstave notation=true tablature=false key=C time=4/4', 2, NULL, '', ''),
(8, 1, 'Ez egy másik példaének', 'asdasdasd', 'options stave-distance=30 space=10\ntabstave notation=true tablature=false key=C time=4/4', 1, '7', 'ez,egy,címke', 'Ez itt egy megjegyzés'),
(9, 1, 'Hull a pelyhes fehér hó', '[a] A      /       D     A   D       A      E   A  [/a]\nHull a pelyhes fehér hó, jöjj el kedves Télapó!\n[a]A      /       D     A    D     A    E      A[/a]\nMinden gyermek várva vár, vidám ének hangja száll.\n[a]A      E      A      E   A     E     A    E[/a]\nVan zsákodban minden jó, piros alma, mogyoró,\n[a]A       A7       D      A    A      E        A    [/a]\nJöjj el hozzánk, várunk rád, kedves öreg Télapó.\n\nNagy szakállú Télapó jó gyermek barátja.\nCukrot, diót, mogyorót rejteget a zsákja.\nAmerre jár reggelig kis cipőcske megtelik,\nmegtölti a Télapó, ha üresen látja!', 'options stave-distance=30 space=10\ntabstave notation=true tablature=false key=C time=4/4', 1, '0', 'télapó,hó,fehér,gyerek,vidám', '');
...
INSERT INTO `songbook` (`id`, `userid`, `title`) VALUES
(1, 12, 'Érdekes'),
(2, 12, 'EZisöüóőú'),
(3, 12, 'Valami új'),
(4, 12, 'Hozzáadom'),
...
(9, 18, 'ABC'),
(10, 18, 'ASD'),
(11, 18, '1 hónap múlva lesz a szülinapom!!!!!!!!!!!44négy'),
(12, 18, '');
